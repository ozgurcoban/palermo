      ...
      <PolicyContainer>
        ...
        <ol>
          <li>
            ...
            ditt namn och din e-postadress används internt av oss för att
            hantera och besvara ditt meddelande. Ditt namn och din e-postadress
          ...
          <li>
            ...
            hanterar dina personuppgifter. Dina personuppgifter kommer endast
            att användas internt och kommer inte att lämnas ut till tredje part
            utan ditt samtycke.
          </li>
          <li>
          ...
          {/* <li>
            ...
            marknadsföringssyften. Du kan när som helst begära att vi raderar
            dina uppgifter genom att skicka ett e-postmeddelande till oss.
          </li> */}
          <li>
            Dessa användarvillkor kan komma att ändras utan förvarning. Vi
            rekommenderar därför att du regelbundet granskar dessa villkor för
            att se till att du förstår dem.
          </li>
        </ol>
      </PolicyContainer>
    </Layout>
