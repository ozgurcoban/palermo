    ...
    <section className="container relative flex flex-col justify-center space-y-8 border-t py-24">
      ...
      <div className="container relative hidden h-[60rem] bg-transparent py-16 lg:block">
        ...
        <div className="grid-template-rows-[auto_1fr_auto] relative grid h-full items-center justify-center gap-10 text-white">
          ...
          {/* Fakta om Palermo */}
          <div className="flex flex-col items-center gap-6 space-y-8 rounded-lg border border-white/15 bg-black/40 p-10 shadow-md shadow-black/20 backdrop-blur-xl">
            <h3 className="title-tertiary font-bold text-accent-soft-apricot drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]">
              Fakta om Palermo
            </h3>
            <ul className="mt-10 grid list-inside grid-cols-1 gap-14 text-xl sm:grid-cols-2">
              <li className="flex flex-col gap-2">
                <Sofa className="mb-2 size-16 text-secondary drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]" />
                <span className="drop-shadow-[0_1px_2px_rgba(0,0,0,0.5) text-2xl">
              ...
              <li className="flex flex-col gap-2">
                <Pizza className="mb-2 size-16 text-secondary drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]" />
                <span className="drop-shadow-[0_2px_3px rgba(0,0,0,0.2)] text-2xl">
